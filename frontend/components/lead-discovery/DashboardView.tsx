...
export default function DashboardView() {
  ...
  return (
    <main className="min-h-screen bg-[#fbfaf7] text-[#111111]">
      <div className="border-b border-black/10 bg-white px-8 py-2 text-right"><a href="/lead-discovery/sales" className="font-semibold underline">销售机构名单 · 分配 / CSV</a></div>
    ...
    <div className="fixed inset-0 z-50 bg-black/45">
      <aside className="ml-auto flex h-full w-full max-w-3xl flex-col overflow-y-auto border-l-2 border-black bg-[#fbfaf7] shadow-2xl">
        <div className="sticky top-0 z-10 flex items-start justify-between border-b-2 border-black bg-white p-6">
          ...
          <button aria-label={locale === "zh" ? "关闭线索详情" : "Close lead details"} onClick={onClose} className="flex h-10 w-10 items-center justify-center border-2 border-black bg-white">
            <X className="h-5 w-5" />
          </button>
        </div>
