...
export const museumLabels: Record<Locale, Record<string, string>> = {
  ...
  zh: {
    ...
    "Jilin Provincial Museum": "吉林省博物馆",
    "Zhejiang Provincial Museum": "浙江省博物馆",
    "Inner Mongolia Museum": "内蒙古博物院",
    "Jiangxi Provincial Museum": "江西省博物馆",
    "Capital Museum Culture Development Co., Ltd.": "首博文化发展有限公司",
    "Liaoning Provincial Library": "辽宁省图书馆",
    "Zhejiang Museum of Natural History": "浙江自然博物馆",
    "Chongqing Natural History Museum": "重庆自然博物馆",
    "Haihunhou Museum": "海昏侯博物馆",
    "Beijing Capital Museum Culture Development Co., Ltd.": "北京首博文化发展有限公司",
    "Fujian Museum": "福建博物院",
